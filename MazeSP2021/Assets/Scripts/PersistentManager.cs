...
public class PersistentManager : MonoBehaviour
{
    ...
    public bool audioWaitActive;
    public List<string> alloAudioAnswers;
    public List<string> egoAudioAnswers;
    ...
    private void Awake()
    {
        if (Instance == null)
        {
            ...
            audioAnswer = "";
            hasAnswered = false;
            audioWaitActive = false;
            alloAudioAnswers = new List<string>();
            egoAudioAnswers = new List<string>();
